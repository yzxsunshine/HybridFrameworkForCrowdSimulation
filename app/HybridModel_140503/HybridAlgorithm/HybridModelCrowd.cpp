...
HybridModelCrowd::HybridModelCrowd():m_agents(0),m_maxAgents(0),m_activeAgents(0),m_grids(0),/*m_pathResult(0),m_navquery(0),m_grid(0),*/m_root(0),m_rvosim(0), m_fluidsim(0),m_activeGrids(0),m_maxGrids(0)
{
...
bool HybridModelCrowd::init(const int maxAgents, const float maxAgentRadius, NavMesh* nav, const float grid_size, const float ox, const float oy, const float ex, const float ey)
{
	purge();
