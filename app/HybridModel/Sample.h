...
protected:
	...
	class InputMesh* m_mesh;
	class NavMesh* m_navMesh;
	class NavMeshQuery* m_navQuery;
	class dtCrowd* m_crowd;
	class TileCtrl* m_tileCtrl;
...
//	virtual class InputGeom* getInputGeom() { return m_geom; }
	virtual class InputMesh* getInputMesh() { return m_mesh; }
	virtual class NavMesh* getNavMesh() { return m_navMesh; }
	virtual class NavMeshQuery* getNavMeshQuery() { return m_navQuery; }
	virtual class TileCtrl*	getTileCtrl()	{ return m_tileCtrl; }
